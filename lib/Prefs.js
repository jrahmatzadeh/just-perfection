...
var Prefs = class
{
    ...
    constructor(dependecies, shellVersion)
    {
        ...
        this._setKey('visiblity', 'app-menu-icon', 'GtkSwitch', true);
        this._setKey('visiblity', 'clock-menu', 'GtkSwitch', true);
        this._setKey('visiblity', 'panel-notification-icon', 'GtkSwitch', true);
        ...
        this._setKey('visiblity', 'panel-arrow', 'GtkSwitch',
            this._shellVersion < 40);
