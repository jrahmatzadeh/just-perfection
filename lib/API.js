...
var API = class
{
    ...
    {
        if (!this._originals['windowPreview']) {
            return;
        }
        
        let windowPreviewProto = this._windowPreview.WindowPreview.prototype;
        windowPreviewProto._getCaption = this._originals['windowPreview'];
    ...
    windowPreviewCaptionDisable()
    {
        ...
        if (!this._originals['windowPreview']) {
            this._originals['windowPreview'] = windowPreviewProto;
        }
