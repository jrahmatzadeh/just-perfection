...
var API = class
{
    ...
    /**
     * remove everything from GNOME Shell that have been added by this class 
     *
     * @return void
     */
    close()
     ...
     *
     * @param bool revert true means add the fix, false means revert the fix
     *
     * @return void
     */
    _fixLonelyOverview(revert)
    {
        ...
        let panelVisible = this._main.panel.visible;
        ...
        if (!panelVisible && !dashVisible && !workspaceSwitcherVisible) {
    ...
    panelHide()
    {
        ...
        let topMargin = (this._shellVersion < 40) ? 10 : 30;
        
        this._main.overview.searchEntry.style
        = `margin-top: ${topMargin}px; margin-bottom: 10px;`;
    }
    ...
    {
        this._main.layoutManager.uiGroup.has_style_class_name(className);
    }
