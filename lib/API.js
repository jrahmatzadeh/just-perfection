...
var API = class
{
     ...
     *   'StSettings' reference to St::Settings
    ...
    constructor(dependecies, shellVersion)
    {
        ...
        this._stSettings = dependecies['StSettings'] || null;
    ...
    animationSpeedSetDefault()
    {
        ...
        this._stSettings.get().slow_down_factor = this._originals['StSlowDownFactor'];
    }
    ...
    animationSpeedSet(factor)
    {
        if (typeof this._originals['StSlowDownFactor'] === 'undefined') {
            ...
            = this._stSettings.get().slow_down_factor;
        }
        
        this._stSettings.get().slow_down_factor = factor;
    }
